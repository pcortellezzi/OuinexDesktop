...
namespace CNergyTrader.Indicator.Indicators
{
    public sealed class ATRStop : IndicatorBase
    {
        ...
        public XYSerie UpTrend { get; private set; } = new XYSerie("Up trend") { DefaultColor = Color.LightGreen };
        public XYSerie DownTrend { get; private set; } = new XYSerie("Down trend") { DefaultColor = Color.OrangeRed };
